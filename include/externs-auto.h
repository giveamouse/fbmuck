...
void add_property(dbref player, const char *pname, const char *class, int value);
...
void copy_proplist(dbref obj, PropPtr * new, PropPtr old);
...
dbref get_property_dbref(dbref player, const char *class);
...
void gui_value_set_local(char *dlogid, char *id, int lines, char **value);
