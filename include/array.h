...
int array_set_strkey_fltval(stk_array ** arr, const char *key, float val);
...
int array_set_intkey_fltval(stk_array ** harr, int key, float val);
...
int array_set_fltval(stk_array ** harr, struct inst* key, float val);
