...
#
# Revision 1.2  1996/07/03 22:49:58  foxen
# fb5.55 checkpoint
#
# Revision 1.1  1996/06/12 03:19:46  foxen
# Initial revision
#
...
const char *infotext[] =
{
    ...
    "  Points:                            Project Lead, Developer",
    "  Foxen/Revar:   foxen@belfry.com    Developer",
    " ",
    "The following people helped out a lot along the way:",
    "  Points, Fre'ta, Kim \"Bookwyrm\" Liu, Chris, Ermafelna, Lynx, WhiteFire,",
